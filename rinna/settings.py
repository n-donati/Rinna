...
SECRET_KEY = 'django-insecure-e@lpopmb+1m%6&gq8(1pr700o7v8$+k%(w*(!s5s&$4u+n=0bh'
...
WSGI_APPLICATION = 'rinna.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "static"),  # Changed back to just "static"
    os.path.join(BASE_DIR, "static"),  # Changed back to just "static"
]
